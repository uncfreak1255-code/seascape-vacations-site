...
- 2026-05-26 copy correction: keep the review-output description concrete, but do not ship internal labels like `proven cost`, `likely cost`, or `missing information` in visible owner copy.
