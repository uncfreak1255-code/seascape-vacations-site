...
5. Produce donor-page suggestions and execution order.
...
- Exclude templated placeholders and non-routable links from the graph.
...
3. Donor-page suggestions per priority target.
